...
import { Wallet, Sparkles, HelpCircle, RotateCcw, Download, ShieldCheck, ArrowRightLeft } from 'lucide-react';
    ...
    <header className="bg-slate-900 border-b border-slate-800 text-slate-100 py-4 px-4 sm:px-8 sticky top-0 z-40 shadow-xl backdrop-blur-md bg-slate-900/95">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-indigo-600 via-purple-600 to-emerald-500 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full font-bold bg-emerald-950 text-emerald-400 border border-emerald-800/60">
                Child Wealth + ESPP
              </span>
            </div>
