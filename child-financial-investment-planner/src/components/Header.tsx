    ...
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="text-xs px-3 py-1.5 rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 font-medium"
              >
                {US_STATES.map((st) => (
            ...
            <button
              ...
              onClick={onExportCSV}
              className="mt-4 sm:mt-0 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-xs transition-colors shadow-xs"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 pt-4 border-t border-slate-100 dark:border-slate-800/80">
          ...
          <div className="bg-indigo-50/70 dark:bg-indigo-950/40 p-3 rounded-xl border border-indigo-100 dark:border-indigo-900/40">
            <div className="flex items-center gap-1.5 text-[11px] text-indigo-600 dark:text-indigo-400 uppercase tracking-wider font-semibold">
              <GraduationCap className="w-3.5 h-3.5" />
              Projected at Age 18
            </div>
            <div className="text-lg font-bold font-mono text-indigo-900 dark:text-indigo-300 mt-1">
              {formatCurrency(projectedAge18Mod)}
            </div>
          </div>

          <div className="bg-slate-900 dark:bg-slate-800 p-3 rounded-xl border border-slate-800 text-white">
            <div className="flex items-center gap-1.5 text-[11px] text-slate-400 uppercase tracking-wider font-semibold">
